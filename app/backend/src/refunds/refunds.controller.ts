...
export class RefundsController {
  ...
  async initiate(
    ...
    await this.contractWritePolicyService.checkWritePolicy(
      ContractWriteOperation.REFUND_INITIATE,
      actorId,
      {
        contractId: dto.entityId,
        metadata: { entityType: dto.entityType, reasonCode: dto.reasonCode },
      },
    );
  ...
  async approve(
    ...
    await this.contractWritePolicyService.checkWritePolicy(
      ContractWriteOperation.REFUND_APPROVE,
      actorId,
      { contractId: id },
    );
  ...
  async reject(
    ...
    await this.contractWritePolicyService.checkWritePolicy(
      ContractWriteOperation.REFUND_REJECT,
      actorId,
      { contractId: id },
    );
